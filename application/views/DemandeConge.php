	...
	<div class="container-fixed">
		...
		<div class="row">
			...
			<div id="maincontent" class="col-md-9">
			 <h2><B><U> DEMANDE  D'ABSCENCE</U></B></h2>
			 <form method="post" class="form-group" name="Conge" action="<?php echo base_url().'index.php/DemandeConge/DemandeConge';?>">
			 	<div class="row">
			 		<div class="col-lg-6">
			 			<label>Nom*:</label>
			 	...
			 	<div class="row">
			 		<div class="col-lg-4">
			 			...
			 			<input type="date" name="dateDebut" value="<?php echo set_value('dateDebut');?>" class="form-control" placeholder="Saisir la date du conge">
			 			
			 		</div>
			 		<div class="col-lg-4">
			 			<label>Au (DateFin)*:</label>
			 			<input type="date" name="dateFin" value="<?php echo set_value('dateFin');?>" class="form-control" placeholder="Saisir la date fin du congé">
			 			
			 		</div>
			 		<div class="col-lg-4">
			 			<label>Jour*:</label>
			 			<input type="number" name="jour" value="<?php echo set_value('jour');?>" class="form-control" placeholder="Saisir le nombre du jour du congé">
			 	...
			 	<div class="row">
			 		<div class="col-lg-6">
			 			...
			 			<select name="typeConge" value="<?php echo set_value('typeConge');?>" class="form-control" placeholder="Choisir le type du conge">
			 		...
			 		<div class="col-lg-6">
			 			<label>Date:</label>
			 			<input type="date" name="date" value="<?php echo set_value('date');?>" class="form-control" placeholder="Saisir la date">
			 	...
			 	<div class="row">
			 		<div class="col-lg-6">
						...
						<button class="btn btn-primary"><span class="glyphicon glyphicon-ok-circle"></span>Ajouter</button>
						</div>	
			 		</div>
			 		<div class="col-lg-6">
			 			<div class="form-group">
 	 	 					<a class="btn btn-primary" href="<?php base_url().'index.php/DemandeConge/index';?>"><span class="glyphicon glyphicon-ban-circle"></span>Annuler</a>
						</div>
