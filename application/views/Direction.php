	...
	<div class="container-fixed">
		...
		<div class="row">
			...
			<div id="maincontent" class="col-md-9">
				<h1><U>Bievenue sur la page de la direction</U></h1></br>
				<p>
				<a id="liste" class="btn btn-warning" href="http://localhost/AppliJIRAMA/index.php/DemandeConge/index">Liste demande conge Valide</a></li>
				<a id="valide" class="btn btn-primary" href="http://localhost/AppliJIRAMA/index.php/DemandeAvance/index">Liste demande d'avance vue SRH</a></li>
				</p></br></br></br>
				<h3>Cliques sur bouton Liste demande conge valide  pour voir leur demande valider  et Clique sur Liste demande d'avance pour voir la liste </h3>
