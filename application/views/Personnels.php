	...
	<div class="container-fixed">
		...
		<div class="row">
			...
			<div id="maincontent" class="col-md-9">
			 <h2><B><U> Ajout Nouveau Personnel</U></B></h2>
			 <form method="post" class="form-group" name="Avance" action="<?php echo base_url().'index.php/Personnels/Personnels';?>">
			 	<div class="row">
			 		<div class="col-lg-6">
			 			<label>Nom*:</label>
			 			<input type="text" name="nomPers" value="<?php echo set_value('nomPers');?>" class="form-control" placeholder="Saisir votre nom">
			 			
			 		</div>
			 		<div class="col-lg-6">
			 			<label>Prenom:</label>
			 			<input type="text" name="prenomPers" value="<?php echo set_value('prenomPers');?>" class="form-control" placeholder="Saisir votre prenom">	
			 		</div>
			 	</div>
			 		<div class="row">
			 		<div class="col-lg-6">
			 			<label>Sexe*:</label>
			 			<input type="text" name="sexe" value="<?php echo set_value('sexe');?>" class="form-control" placeholder="choisir votre sexe">
			 			
			 		</div>
			 		<div class="col-lg-6">
			 			<label>CIN:</label>
			 			<input type="text" name="cin" value="<?php echo set_value('cin');?>" class="form-control" placeholder="Saisir votre CIN">	
			 		</div>
			 	</div>
			 	...
			 	<div class="row">
			 		<div class="col-lg-6">
			 			...
			 			<input type="date" name="dateEmbauche" value="<?php echo set_value('dateEmbauche');?>" class="form-control" placeholder="Saisir votre date d'embauchage">
			 			
			 		</div>
			 		<div class="col-lg-6">
			 			<label>Tel:</label>
			 			<input type="number" name="tel" value="<?php echo set_value('tel');?>" class="form-control" placeholder="Saisir votre numero telephone">
