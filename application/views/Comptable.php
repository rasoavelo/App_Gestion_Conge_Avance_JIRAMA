	...
	<div class="container-fixed">
		...
		<div class="row">
			...
			<div id="maincontent" class="col-md-9">
				<h1><U>Bievenue sur la page du Comptabilite</U></h1></br>
				<p>
				<a id="liste" class="btn btn-warning" href="http://localhost/AppliJIRAMA/index.php/DemandeAvance/index">Liste demande d'avance</a></li>
